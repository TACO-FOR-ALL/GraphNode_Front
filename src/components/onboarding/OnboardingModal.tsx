...
export default function OnboardingModal({ children }: OnboardingModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[10000] flex items-center justify-center">
      ...
      {/* 모달 - 고정 가로 크기 */}
      <div
        className="relative w-[780px] max-w-[calc(100vw-48px)] max-h-[85vh] rounded-2xl bg-bg-primary border border-base-border shadow-2xl overflow-hidden flex flex-col select-none"
      >
        {/* 플랫폼 프레임바 */}
